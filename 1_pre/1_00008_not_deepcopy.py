...
for i in range(0, len(JieqingContain_paperID_authorID_affiliationID_paperYear_normalizedName_displayName)):
    ...
    for j in range(0, len(awardYear_englishName_affID_chineseName)):
        ...
        paperID_authorID_affiliationID_paperYear_normalizedName_displayName_i = []
        for xxx in JieqingContain_paperID_authorID_affiliationID_paperYear_normalizedName_displayName[i]:
            paperID_authorID_affiliationID_paperYear_normalizedName_displayName_i.append(xxx)
        ...
        paperID_authorID_affiliationID_paperYear_normalizedName_displayName_chineseName_awardYear = []
        for xxx in paperID_authorID_affiliationID_paperYear_normalizedName_displayName_i:
            paperID_authorID_affiliationID_paperYear_normalizedName_displayName_chineseName_awardYear.append(xxx)
...
pathOut4 = r"E:\FengXu\result\4_JieQing_paperID_authorID_affiliationID_paperYear_normalizedName_displayName_chineseName_awardYear.txt"

exception_path = r"E:\FengXu\result\exception.txt"
f_exception = open(exception_path, 'w', encoding='utf-8')

with open(pathOut4, "w", encoding='utf-8') as f:
